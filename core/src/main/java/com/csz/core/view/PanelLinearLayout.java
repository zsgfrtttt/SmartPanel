 ...
 * @author caishuzhan
 */
public class PanelLinearLayout extends LinearLayout implements PanelGroup {
    ...
    public PanelLinearLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PanelLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
