 ...
 * @author caishuzhan
 */
public class PanelRelativeLayout extends RelativeLayout implements PanelGroup {
    ...
    public PanelRelativeLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PanelRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
